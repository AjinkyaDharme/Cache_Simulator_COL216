...
class bus
{
    public:
        ...
        void putMsg_onBus(std::string, std::string, std::function<void(unsigned int, unsigned long int, std::string)>, int,unsigned long int &,unsigned long int, unsigned long int &);
